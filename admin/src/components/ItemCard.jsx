    ...
    <div className=" w-full group shadow-md dark:border dark:border-slate-800 flex flex-col gap-y-3 " >
        ...
        <div className="w-full h-[250px] relative">
           ...
           <Link to={`/product-details/${product._id}`}>
            ...
            <div className="w-full text-center cursor-pointer absolute bg-blue-600 opacity-0 group-hover:opacity-100 bottom-0 left-0 duration-500 ease-in translate-y-0 transition-all py-2">
